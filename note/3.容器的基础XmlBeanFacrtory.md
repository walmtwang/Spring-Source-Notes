...
- XMLBeanFactory初始化时序图。![](https://github.com/walmt/Spring-Source-Notes/blob/master/img/4.png?raw=true)
...
- ![](https://github.com/walmt/Spring-Source-Notes/blob/master/img/5.png?raw=true)
...
- `this.reader.loadBeanDefinitions(resource);`这个方法的时序图：![](https://github.com/walmt/Spring-Source-Notes/blob/master/img/6.png?raw=true)
